 ...
 * 消费券记录常量
 */
public class VoucherRecordConstants {
    ...
    public static final String LINK_TYPE_DAILY_RELEASE = "daily_release";
    public static final String LINK_TYPE_TO_BALANCE = "to_balance";
